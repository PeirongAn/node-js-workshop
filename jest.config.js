...
module.exports = {
  ...
  // cacheDirectory:
  // "/private/var/folders/fk/2tft92dx6gdcw_fs8lszgk380000gn/T/jest_dx",
  ...
  // from ignored files using an array of glob patterns
  // forceCoverageMatch: [],
  ...
  // A path to a module
  // which exports an async function that is triggered once after
  // all test suites
